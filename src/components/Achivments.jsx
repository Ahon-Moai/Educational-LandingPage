...
import ach from '../assets/assets/achievement.png'
  ...
  return (
    <>
       <div className='w-full bg-white py-24'>
        <div className='= grid md:grid-cols-2 max-w-[1220px] mx-auto  px-4 md:px-0'>
            ...
            <div className='flex flex-col justify-center '>
             ...
             <img  src={ach} className="m-auto md:order-last  order-first" />
